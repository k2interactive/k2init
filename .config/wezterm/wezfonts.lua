...
function fonts.caskaydia_cove_font_and_rules()
  ...
  local font = wezterm.font("CaskaydiaCove Nerd Font Propo",
    { weight = "DemiLight", stretch = "Normal", style = "Normal" })
...
function fonts.ubuntu_mono_font_and_rules()
  local font = wezterm.font("UbuntuMono Nerd Font Propo", { weight = "Regular", stretch = "Normal", style = "Normal" })
  -- local font = wezterm.font("UbuntuMono Nerd Font Propo", { weight = "Regular", stretch = "Normal", style = "Italic" })
  -- local font = wezterm.font("UbuntuMono Nerd Font Propo", { weight = "Bold", stretch = "Normal", style = "Normal" })
  -- local font = wezterm.font("UbuntuMono Nerd Font Propo", { weight = "Bold", stretch = "Normal", style = "Italic" })
  local font_rules = {}
  return font, font_rules
end
